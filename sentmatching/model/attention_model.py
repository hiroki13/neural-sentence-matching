...
class Model(basic_model.Model):
    ...
    def set_attention_layer(self):
        attention_layer = AttentionLayer(model_type=self.args.model_type, n_d=self.n_d, activation=self.activation)
    ...
    def attention(self, h, idps, ids):
        ...
        # Cand vectors #
        ################
        # 1D: n_queries * n_cands, 3D: dim_h
        cands = h[-1, idps.ravel()]
        # 1D: n_queries, 2D: n_cands-1, 3D: n_d
